...
ExportSeurat(seu.obj = pbmc_small, assay = "RNA",to = "AnnData", conda.path = "/Applications/anaconda3",
...
ExportSeurat(seu.obj = pbmc_small, assay = "RNA",to = "loom", 
...
The conversion is performed with functions implemented in `sceasy`:
```{r anndata2seu}
seu.obj.h5ad = ImportSeurat(anndata.file = "/Users/soyabean/Desktop/tmp/scdown/conversion/pbmc_small.h5ad", 
                            from="AnnData", assay = "RNA")
seu.obj.h5ad
```
...
```{r anndata2sce}
seger.anndata = SCEAnnData(from = "AnnData", to = "SingleCellExperiment",
                           anndata.file = "/Users/soyabean/Desktop/tmp/scdown/conversion/seger.h5ad")
seger.anndata
```
...
SCELoom(from = "SingleCellExperiment", to = "loom",sce = seger,
...
```{r loom2sce}
seger.loom = SCELoom(from = "loom", to = "SingleCellExperiment",
                     loom.file = "/Users/soyabean/Desktop/tmp/scdown/conversion/seger.loom")
seger.loom
```
